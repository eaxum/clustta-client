...
const createEntityType = () => {
  CollectionService.CreateEntityType(projectTemplateStore.activeProjectTemplate.uri, entityTypeName.value, entityTypeIcon.value)
    .then((response) => {
