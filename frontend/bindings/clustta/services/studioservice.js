 ...
 * @returns {$CancellablePromise<studio_service$0.StorageConversionState>}
 */
export function StartStorageConversion(studioUrl, projectName, targetMode, $3) {
    return $Call.ByID(182693000, studioUrl, projectName, targetMode, $3).then(/** @type {($result: any) => any} */(($result) => {
