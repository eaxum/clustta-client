  ...
  <div ref="modalContainer" class="modal-container">
    ...
    <div class="general-container">
      ...
      <div class="pop-up-actions">
        ...
        <GeneralButton :label="$t('common.duplicate')" :fullWidth="true" @click="duplicateProjectTemplate"
...
// constants
const title = 'Duplicate project template';
...
// Duplicates the project template with a new name.
const duplicateProjectTemplate = async () => {
  ...
  await FSService.DuplicateFile(oldTemplatePath, newTemplatePath).then(async () => {
    ...
    isAwaitingResponse.value = false;
    console.log(error);
    notificationStore.errorNotification(t('notifications.errorDuplicatingProjectTemplate'), error);
  });
  isAwaitingResponse.value = false;
};
