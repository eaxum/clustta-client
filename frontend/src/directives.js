...
const getHighestZIndexElement = () => {
  const selector = '.searchbar-container, .checkpoint-item, .list-tags, .tag-parent, .tray-overlay-mask, .pop-up-container, .data-name-input, .dash-board-root, .tray-home, .combo-new-chip, .asset-item-menu-container, .asset-list-container, .asset-list-root, .modal-mask, .dash-board-root';
